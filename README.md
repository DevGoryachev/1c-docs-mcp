...
- `MCP_PUBLIC_BASE_URL` — публичный base URL для shared/internal подключения (например `http://<YOUR_HOST_OR_IP>:3000`).
...
MCP_HTTP_BEARER_TOKEN=<YOUR_STRONG_TOKEN>
```
...
docker run --rm -p 3000:3000 \
  ...
  -e MCP_HTTP_BEARER_TOKEN=<YOUR_STRONG_TOKEN> \
  1c-docs-mcp:latest
```
...
MCP_PUBLIC_BASE_URL=http://<YOUR_HOST_OR_IP>:3000
MCP_HTTP_AUTH_ENABLED=true
MCP_HTTP_BEARER_TOKEN=<YOUR_STRONG_TOKEN>
